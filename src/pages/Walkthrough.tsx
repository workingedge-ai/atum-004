  ...
  return (
    <div className="min-h-screen gradient-hero flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-3xl">
        <Card className="gradient-card shadow-glow p-8 md:p-12 border-border">
          <div className="text-center mb-8">
            <h1 className="text-4xl font-bold text-secondary mb-4">Welcome to Atum Affiliate Program</h1>
          ...
          <div className="space-y-6 mb-8">
            ...
            <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
              <h3 className="text-xl font-semibold mb-3">Payout Flow</h3>
